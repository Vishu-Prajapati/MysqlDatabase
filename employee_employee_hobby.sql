...
CREATE TABLE `employee_hobby` (
  `id` int NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_employe_id` FOREIGN KEY (`id`) REFERENCES `employee` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_hobby_id` FOREIGN KEY (`id`) REFERENCES `hobby` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-10-28 16:34:38
